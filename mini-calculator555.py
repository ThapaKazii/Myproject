...
if input1 == 'A':
    ...
    if input2 == '1':
        ...
        if num.isnumeric() == True or num.isalpha() == False == False:
    ...
    if input3 == '1':
        ...
        if principle.isnumeric() == True or principle.isalpha() == False == False:
            time = (input("\tEnter the time..  "))
            if time.isnumeric() == True or time.isalpha() == False == False:
                rate = (input("\tEnter the rate.. "))
                if rate.isnumeric() == True or rate.isalpha() == False == False:
        ...
        if input4 == '1':
            ...
            if input5 == 'A':
                ...
                if aud.isnumeric() == True or aud.isalpha() == False == False:
                ...
                if npr.isnumeric() == True or npr.isalpha() == False == False:
            ...
            if input5 == 'A':
                ...
                if uae.isnumeric() == True or uae.isalpha() == False == False:
                    npr = float(uae) * 31.28
                    print("\tNepalese rupee:\t", float(npr))
                else:
                    print("Invalid input..")
            ...
            if input5 == 'A':
                ...
                if usd.isnumeric() == True or usd.isalpha() == False == False:
                    print("Invalid input..")
                else:
            ...
            if input5 == 'A':
                ...
                if inr.isnumeric() == True or inr.isalpha() == False == False:
                    npr = float(inr) * 1.60
                    print("\tNepalese rupee:\t", float(npr))
                else:
                    print("Invalid input..")
        ...
        if input4 == '5':
            ...
            if input5 == 'A':
                ...
                if eus.isnumeric() == True or eus.isalpha() == False == False:
